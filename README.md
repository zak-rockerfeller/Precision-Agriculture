...
It makes use of the ESP8266 development board, DHT sensor and a soil moisture sensor. We will use MQTT protocol to send data to the raspberry pi. MQTT is a lightweight, publish-subscribe, machine to machine network protocol.
...
2. Installation of the MQTT broker on the Raspberry Pi https://pimylifeup.com/raspberry-pi-mosquitto-mqtt-server/
